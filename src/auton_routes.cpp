...
// Adjustable push timing delay for leftPushFast / rightPushFast.
// Set via selectPushDelay() during pre-match; default 0 ms.
int pushDelay = 0;
...
void odomAWPHigh(int i){
    ...
    pros::Task IntakeTask([]
                         { delay(1300);
                        loader.set_value(HIGH);});
    chassis.moveToPose(-20.942,30.97,0,1800,{.forwards=true, .lead=.1},false);
    loader.set_value(HIGH);
    //lift.set_value(LOW);
    intake.brake();
    //outake(500);
    //stopper.set_value(HIGH);
    chassis.moveToPose(-8.211,5.626,315,1500,{.forwards=false, .lead=.3},false);
    outake(100);
    intakeTop.move(-50);
    intake.move(100);
    ...
    chassis.moveToPose(-45.75,46.449,315,1200,{.forwards=true, .lead=.0},false);
    //drivePID(50,1200,50);
    intake.move(127); 
    intakeTop.move(127);
    chassis.turnToHeading(270,500,{},false);
...
void leftPush(int i){
    ...
    deScores.set_value(HIGH);
    drivePID(30.4,900,70);//go to loader //29.3
    chassis.turnToHeading(273,800,{},false);
    deScores.set_value(LOW);
    drivePID(20,800,30);//get loader balls
    //chassis.turnToHeading(-270,400,{},false);
    //drivePID(1.5,200);//shimmy 
    drivePID(-5,200,130);
    chassis.turnToHeading(271,200,{},false);
    ...
    chassis.moveToPose(-6.211,2.357,315,1300,{.forwards=false, .lead=.2},false);
    //outake(60);
    ...
    chassis.moveToPose(-23.458,35.758,45,1100,{.forwards=true, .lead=.5},false);
    intakeTop.brake();
    stopper.set_value(LOW); 
    intake.brake();
...
void rightPush(int i){
    ...
    drivePID(27.8,900);//go to loader //29.3
    deScores.set_value(LOW);
    chassis.turnToHeading(267,700,{},false);
    drivePID(30,700,23);//get loader balls
    //chassis.turnToHeading(-270,400,{},false);
    drivePID(1.5,200);//shimmy
    drivePID(-5,200,130);
    chassis.turnToHeading(268,200,{},false);
    ...
    loader.set_value(LOW);
    chassis.moveToPose(-8.54,-9.166,45,1000,{.forwards=true, .lead=.5},false);
    intake.move(-60);
    intakeTop.move(-50);
    delay(1000);
...
void skillsFinal(int i){
  ...
  /*
    ...
    chassis.moveToPose(-17.476,0,340,1400,{.forwards=false, .lead=.1},false);
    //lift.set_value(LOW);
    chassis.moveToPose(-19.919,19.05,330,1250,{.forwards=true, .lead=.1},false);
    ...
    chassis.moveToPose(21.57,50.305,90,1600,{.forwards=false, .lead=.5},false);
    /* odom loader to goal
   ...
   /* drivePID(10,400);
    ...
    loader.set_value(HIGH);
    intakeTop.move(100);
    chassis.moveToPose(47.637,-48.543,180,2000,{.forwards=true, .lead=.0},false);
    chassis.turnToHeading(90,600,{},false);
    
    drivePID(30,1200,17);//get loader balls ////////////////CUT FROM HERE 
    drivePID(-0.5,700);//shimmy
    drivePID(5,500);
    /*drivePID(-1.5,500);
    drivePID(5,500);
    drivePID(-1.5,500);*/
    ...
    drivePID(-35,1000,50);//go to score
    //outake(200);
    stopper.set_value(HIGH);
...
void rightPushFast(int i){
    ...
    drivePID(31,700);
    loader.set_value(HIGH);
    chassis.turnToHeading(220,900,{},false);
    drivePID(38,970);
    chassis.turnToHeading(270,500,{},false);
    drivePID(27,700,23);//get loader balls
    //drivePID(-0.5,200);//shimmy
    //drivePID(5,200,130);
    chassis.turnToHeading(266,400,{},false);
    drivePID(-35,900,40);
    loader.set_value(LOW);
    intake.move(-127);
    intakeTop.move(-127);
    ...
    delay(pushDelay); // Adjusted via selectPushDelay() before the match

    drivePID(-29,2000,100);
}
void leftPushFast(int i){
    ...
    drivePID(34.8,900);
    chassis.turnToHeading(270,500,{},false);
    drivePID(41,700,24);//get loader balls
    drivePID(1.5,200);//shimmy
    drivePID(-5,200,130);
    chassis.turnToHeading(269,200,{},false);
    drivePID(-30,900,40);
    loader.set_value(LOW);
    intake.move(-127);
    intakeTop.move(-127);
    ...
    chassis.moveToPose(-48.692,-39.036,270,1000,{.forwards=true, .lead=.1},false);
    
    chassis.turnToHeading(267,200,{},false);

    delay(pushDelay); // Adjusted via selectPushDelay() before the match

    drivePID(-27,2000,100);
